...
$req = $bdd->query('SELECT * FROM historique ;'); // pour les fac
...
?>		
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white time"></i><span class="break"></span>Anciennes Factures</h2>
						<div class="box-icon">
	...
	echo '
							...
							<tr>
								...
								<td class="center">'.$data['marque'].'  '.$data['modele'].'</td>
								
								
								<td class="center">
									
									<a class="btn btn-success" href="vaprint.php?action=historique&amp;id='.$data['id'].'" >voir
								...
								';	
									if($_SESSION['level']==2){
										echo '
									<!--
									<a class="btn btn-danger" href="supprimer.php?action=historique&amp;id='.$data['id'].'" >supprimer
...
<script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript"></script>
		...
		<script >	
											...
											link.href = "supprimer.php?action=historique&id="+art;
	...
	<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
              <div class="modal-dialog">
				...
				<?php 
				echo '
					<a id="myLink" href="supprimer.php?action=historique&amp;id=s" ><button class="btn btn-primary btn-xs" ><i class="fa fa-pencil"></i>Oui</button></a>
					 ';
