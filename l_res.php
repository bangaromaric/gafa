...
$req = $bdd->query('SELECT * FROM reservations ;'); // pour les fac
...
$ent = $rete->fetch();
	...
	echo'
			<div class="row-fluid">		
			<img class="grayscale" src="img/logo/'.$ent['photo'].'" alt="Sample Image 1" style="max-height: 100px;max-width: 100px; float: left;margin: 3px 15px 10px 10px;	border: none;border-radius:30%;" alt="Dennis Ji"    >	
			<h5 class="span8"  ></h5>
...
?>		
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white time"></i><span class="break"></span>Les reservations</h2>
						<div class="box-icon">
	...
	echo '
							...
							<tr>
								...
								<td class="center">'.date("d-m-Y", strtotime($data['datel'])).' </td>
								
								
								<td class="center">
									
									<a class="btn btn-success" href="supprimer.php?action=activer&amp;id='.$data['id'].'" >Activé
										<i class="halflings-icon white zoom-in"></i>                                            
									</a>						
									
									
									<!--
									<a class="btn btn-danger" href="supprimer.php?action=reservation&amp;id='.$data['id'].'" >supprimer
...
<script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript"></script>
		...
		<script >	
											...
											link.href = "supprimer.php?action=reservation&id="+art;
	...
	<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
              <div class="modal-dialog">
				...
				<?php 
				echo '
					<a id="myLink" href="supprimer.php?action=reservation&amp;id=s" ><button class="btn btn-primary btn-xs" ><i class="fa fa-pencil"></i>Oui</button></a>
					 ';
