...
if(isset($_POST['submit']))
{
    ...
    $extensions_valides = array('jpg','png');
			...
			$chi = $bdd->query('SELECT * FROM admin WHERE id= '.$_POST['id'].'');
			$chaui = $chi->fetch();
...
$req = $bdd->prepare('UPDATE admin SET nom= UPPER(:nom) , prenom= UPPER(:prenom),
tel= :tel, login= :login, photo= :photo, mdp= :mdp, mail= :mail,level= :level WHERE id = :id ');
$req->execute(array(
'nom' => $_POST['nom'],
'prenom' => $_POST['prenom'],
'tel' => $_POST['tel'],
...
header('Location:l_user.php?noty=noty');
exit();
//$id = $connexion -> id() ;
	?>	
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Modification de l'utilisateur</a></li>
			</ul>		
	...
	echo '
					...
					<div class="box-content">
						<ul class="dashboard-list metro">
							<li class="green">
									...
									<img src="img/user/'.$chau['photo'].'" style="height: 180px;width: 180px; float: left;	margin: 3px 15px 0px 10px;	border: none;	border-radius:50%;" alt="Dennis Ji" >
								</a>
								<h5>
								...
								<strong><u>Dernière deconnexion</u>:</strong> '.$chau['heurde'].'<br>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" action="modi_user.php" enctype = "multipart/form-data">
						  <fieldset>
							<div class="control-group">
							 ...
							 <div class="alert alert-success">	
								...
								<div class="controls">
								  <input required type="text" id="inputSuccess required"   name="login" value="'.$chau['login'].'" >
							  ...
							  <div class="control-group success">
                                            ...
                                            <div class="controls">
                                                <input type="email" id="email2" name="email" value="'.$chau['mail'].'" class="form-control" />
                                            </div>
                               </div>
							  <div class="control-group">
							...
							<div class="control-group success">
								...
								<div class="controls">
								  <label class="radio">
									<input type="radio" name="status" id="optionsRadios1" value=1 >Gestionnaire
								  </label>
								  <div style="clear:both"></div>
								  <label class="radio">
									<input type="radio" name="status" id="optionsRadios2" value=2 checked="">Administrateur
								  </label>
								</div>
							  </div>
