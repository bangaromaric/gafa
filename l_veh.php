...
while ($data= $req->fetch())
	...
	?>						  												  
							<tr>
								...
								<td class="center"><?php echo $data['energie'];?></td>
								<td class="center">
								...
								{	
									if($datae['id_voi']==$data['id'])					
										echo' Du '.date("d-m-Y", strtotime($datae['assurDateDebut'])).'  au '.date("d-m-Y", strtotime($datae['assurDateFin'])).'' ;
										...
										//echo"de 1245-15-00 à 1245-15-00"	
										?>
						
								</td>
								<td class="center">
								
									<a class="btn btn-info " href="affiche.php?action=vehicule&amp;id=<?php echo $data['id'];?>" >voir
									...
									if($_SESSION['level']==2){
									echo '
									<a class="btn btn-info" href="modi_veh.php?action=vehicule&amp;id='.$data['id'].'" >modifier
										<i class="halflings-icon white edit"></i>                                            
									</a>
									<!--
									<a class="btn btn-danger " href="supprimer.php?action=vehicule&amp;id='.$data['id'].'">supprimer
...
?>						
			...
			<div class="col-lg-4">
                        ...
                        <div >
                            <a class="btn btn-info" href="add_veh.php" >ajouter
		...
		<script >	
											...
											link.href = "supprimer.php?action=vehicule&id="+art;
	...
	<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
              <div class="modal-dialog">
				...
				<?php 
				echo '
					<a id="myLink" href="supprimer.php?action=vehicule&amp;id=s" ><button class="btn btn-primary btn-xs" ><i class="fa fa-pencil"></i>Oui</button></a>
					 ';
