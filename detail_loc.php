...
<body>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" action="n_loc.php" >
						  <fieldset>
							<div class="control-group">
							  
							  <div class="alert alert-success">	
							    <strong>détail de la location</strong> 
					        	</div>
								
								<div class="control-group success">
                                    <label class="control-label" for="inputSuccess">Date de location</label>

                                      <div class="controls">
                                          <input required type="date" name="datel" id="date2" placeholder="1990-12-22(utiliser ce format)" class="form-control" />
                                      </div>
                                </div>
								<div class="control-group success">
                                    <label class="control-label" for="inputSuccess">Date de retour</label>

                                      <div class="controls">
                                          <input required type="date" name="dater" id="date2" placeholder="1990-12-22(utiliser ce format)" class="form-control" />
                                      </div>
                                </div>
								...
								<div class="control-group  success">
								<label class="control-label" for="selectError">Choix du chauffeur</label>
								<div class="controls">
								  <select name="chauffeur"  data-rel="chosen" onchange="document.getElementById('affi').innerHTML = document.getElementById(this.value).innerHTML;">>														
		<?php
	...
	{	
		...
		?>
			...
			<!-- pour chauffeur déjà sur une réservation-->
