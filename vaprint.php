...
<?php
 ...
 $chi = $bdd->query('SELECT * FROM historique WHERE id= '.$_GET['id'].'');
 $fact = $chi->fetch();
...
<page style="font-size: 12pt" backimg="./images/sign.png" backimgy="bottom">
    <table cellspacing="0" style="width: 100%; text-align: center; font-size: 14px">
        ...
        <tr>
            ...
            <td style="width:36%">M. '.$fact['nom'].' '.$fact['prenom'].'</td>
        </tr>
        <tr>
            <td style="width:50%;"></td>
        ...
        <tr>
            ...
            <td style="width:36%">(241) '.$fact['tel'].'</td>
        </tr>
 </table>
...
<barcode type="EAN13" value="123467891245" style="margin-left:100mm;margin-top:10mm;width: 30mm; height: 12mm; font-size: 4mm"></barcode>
    ...
    <table class="dataTable" cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
        <tr>
            <td style="width: 20%">'.$fact['matricule'].'</td>
            <td style="width: 20%">'.$fact['marque'].'</td>
            <td style="width: 20%; text-align:right;">'.$fact['modele'].'</td>';
			if( !empty($fact['npchc']) )
            echo '<td style="width: 20%; text-align:right;">'.$fact['npchc'].'</td>';
            else
			echo '<td style="width: 20%; text-align:right;">'.$fact['npch'].'</td>';	
        echo '
		</tr>
	...
	<table class="dataTable" cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
        <tr>
            ...
            <td style="width: 20%; text-align:right;">'.$fact['prixj'].' FCFA</td>
