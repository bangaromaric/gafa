			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white time"></i><span class="break"></span>clients</h2>
						<div class="box-icon">
...
while ($data= $req->fetch())
	...
	?>						  												  
							<tr>
								...
								echo '
									<a class="btn btn-info " href="affiche.php?action=client&amp;id='.$data['id'].'" >voir
										<i class="halflings-icon white zoom-in"></i>                                            
									</a>
									<!--
									<a class="btn btn-info" href="modi_cli.php?action=client&amp;id='.$data['id'].'" >modifier
									...
									';
										if($_SESSION['level']==2){
											echo'
									<!--
									<a class="btn btn-danger " href="supprimer.php?action=client&amp;id='.$data['id'].'">supprimer
...
?>						
		...
		<script >	
											...
											link.href = "supprimer.php?action=client&id="+art;
	...
	<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
              <div class="modal-dialog">
				...
				<?php 
				echo '
					<a id="myLink" href="supprimer.php?action=client&amp;id=s" ><button class="btn btn-primary btn-xs" ><i class="fa fa-pencil"></i>Oui</button></a>
					 ';
