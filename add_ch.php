...
$stat="libre";
$req = $bdd->prepare('INSERT INTO chauffeur(nom, prenom,
tel, permis, numPermis, photo, status) VALUES(:nom,
:prenom, :tel, :permis, :numPermis, :photo, :status)');
$req->execute(array(
'nom' => $_POST['nom'],
'prenom' => $_POST['prenom'],
'tel' => $_POST['tel'],
	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Ajout du chauffeur</a></li>
			</ul>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" action="add_ch.php" enctype = "multipart/form-data">
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="control-group success">
								...
								<div class="controls">
								  <input required type="text" id="inputSuccess" name="numPermis">
								  <span class="help-inline"></span>
								</div>
							  </div>
