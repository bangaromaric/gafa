			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white time"></i><span class="break"></span>Utilisateurs</h2>
						<div class="box-icon">
...
while ($data= $req->fetch())
	...
	?>						  												  
							<tr>
								<td class="center"><?php echo $data['login'];?></td>
								<td class="center"><?php echo $data['nom'];?></td>
								<td class="center"><?php echo $data['prenom'];?></td>
								<td class="center"><?php echo $data['tel'];?></td>
								<td class="center">
								<?php if($data['level']==2)   	
										echo '<span class="label label-important">Administrateur</span>';
								      else if($data['level']==1)    	
										echo '<span class="label label-success">Gestionnaire</span>';
								...
								<td class="center">
									<a class="btn btn-info" href="affiche.php?action=admin&amp;id=<?php echo $data['id'];?>" >Voir
									...
									if($_SESSION['level']==2){
										echo '
									<a class="btn btn-info" href="modi_user.php?action=admin&amp;id='.$data['id'].'" >modifier 
										<i class="halflings-icon white edit"></i>                                            
									</a>
								<!--	
									<a class="btn btn-danger " href="supprimer.php?action=admin&amp;id='.$data['id'].'" onclick="return sure();" >supprimer
								...
								-->
									...
									echo '
								<!--
								<button type="submit" class="btn btn-danger" data-toggle="modal" data-target="#myModal2" href="l_user.php?action=admin&amp;id='.$data['id'].'#myModal2">Réservation
									  <i class="halflings-icon white trash"></i>
									</button>
...
?>						
			...
			<div class="col-lg-4">
                        ...
                        <div >
                            <a class="btn btn-info" href="add_user.php" >ajouter
...
<script >	
	function sure()
{
	return(confirm('Etes-vous sûr de vouloir le supprimer  ?'));
}
</script>
...
<script >	
											...
											link.href = "supprimer.php?action=admin&id="+art;
	...
	<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
              <div class="modal-dialog">
				...
				<?php 
				echo '
					<a id="myLink" href="supprimer.php?action=admin&amp;id=s" ><button class="btn btn-primary btn-xs" ><i class="fa fa-pencil"></i>Oui</button></a>
					 ';
